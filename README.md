...
| #PR | Status | Summary |
| --- | --- | --- |
| [LMDeploy #4853](https://github.com/InternLM/lmdeploy/pull/4853) | 🟢 | Optimize GLM-5.2 serving performance (CUDA all-reduce, fp32 router GEMM, etc.). |
| [LMDeploy #4827](https://github.com/InternLM/lmdeploy/pull/4827) | 🟣 | Optimize GLM-5.2 serving performance (DSA indexing, Q/KV-A projection fusion, LM-head sharding, etc.). |
